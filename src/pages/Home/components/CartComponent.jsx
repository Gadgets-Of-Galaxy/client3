...
export const CartComponent = ({ user }) => {
    ...
    useEffect(() => {
        const fetchCartItems = async () => {
            try {
                const response = await axios.get(`https://server2-acel.onrender.com/api/carts/${user._id}`);
    ...
    const handleCheckout = async () => {
        try {
            ...
            const response = await axios.post('https://server2-acel.onrender.com/api/checkout', checkoutData);
